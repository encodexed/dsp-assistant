<script lang="ts">
	...
	import CollapsibleWrapper from './UI/CollapsibleWrapper.svelte';
</script>

<div class="flex w-full flex-col border">
	{#if inputStore.ui}
		<CollapsibleWrapper heading="Settings">
			<div>
			...
			<div class="flex p-2">
				...
				<div class="border p-2">
					...
					<SelectBuildingType
						name={'miners'}
						range={miners}
						bind:state={buildingSelections.miners}
					/>
				</div>
				<div class="border p-2">
					...
					<SelectBuildingType
						name={'plants'}
						range={plants}
						bind:state={buildingSelections.plants}
					/>
				</div>
				<div class="border p-2">
					<h4>Labs</h4>
		...
		<CollapsibleWrapper heading="Total Requirements" h={34}>
			<TotalRequirements />
		</CollapsibleWrapper>
		<CollapsibleWrapper heading="Total Resources" h={68}>
			<TotalResources />
		</CollapsibleWrapper>
		{#if inputStore.surplus.length}
			<CollapsibleWrapper heading="Surplus" h={34}>
				<Surplus />
			</CollapsibleWrapper>
		{/if}
		<ResourceCards />
